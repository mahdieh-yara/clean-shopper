...
Be direct and specific. Vague feedback is not useful. For every issue you identify, name exactly what is wrong and exactly how to fix it. Be strict. A prompt that could be interpreted two ways is not Strong on Clarity.
